...
use App\Filament\Resources\ManagerResource\RelationManagers\CounterpartiesRelationManager;
use App\Models\User;
...
class ManagerResource extends Resource
{
    ...
    protected static ?string $label = 'Торговый';
    protected static ?string $pluralLabel = 'Торговые';
    ...
    {
        return [
            CounterpartiesRelationManager::class,
        ];
    }
    ...
    {
        $count = User::where('status', 'waiting')->where('role_id', 2)->count();
